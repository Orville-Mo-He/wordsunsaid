...
function draw() {
    ...
    push();
    gravity = lerp(gravity, gravityMod, 0.002)
...
class Unsaid_fast {
    ...
    constructor() {
        ...
        this.xMin = 0.40401785714285715 * width + (lineLength / 2); //left 
        this.xMax = 0.59765625 * width - (lineLength / 2); //right 
        ...
        for (this.i = 0; this.i < this.txts.length; this.i++) {
            ...
            this.yMin[this.i] = (0.0939153439153439 * height) + (alltheheights[this.i] / 2);
    ...
    words() {
        ...
        for (this.i = 0; this.i < 1; this.i++) {
            ...
            // //baseline blur
            // text(this.txts[this.i], 0, 0, lineLength);
            // text(this.txts[this.i], this.bf / 2, 0, lineLength);
            // text(this.txts[this.i], -this.bf / 2, 0, lineLength);
            // //y shift blur
            // text(this.txts[this.i], this.bf, this.bf / 2, lineLength);
            // text(this.txts[this.i], -this.bf, this.bf / 2, lineLength);
            // //-yshift blur
            // text(this.txts[this.i], this.bf, -this.bf / 2, lineLength);
            // text(this.txts[this.i], -this.bf, -this.bf / 2, lineLength);
            ...
            rect(this.tx[this.i], this.ty[this.i]+alltheheights[this.i]/2, lineLength, alltheheights[this.i])
